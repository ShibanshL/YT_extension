...
// var useAlternativeImages: any;
// var flipBlacklist: any; // Stores flipBlackList.js
// var blacklistStatus: any;
...
//     overlayImage,
//     thumbnailElement.nextSibling /*Makes sure the image doesn't cover any info, but still overlays the original thumbnail*/
//   );
// }

// function FindThumbnails() {
//   var thumbnailImages = document.querySelectorAll(
...
//   );
//   var notificationImages = document.querySelectorAll(
//     'img.style-scope.yt-img-shadow[width="86"]'
//   );

//   const allImages = [
//     // Put all the selected images into an array
...
//   var listAllThumbnails = allImages.filter((image: any) => {
...
//   var videowallImages = document.querySelectorAll(
//     ".ytp-videowall-still-image:not([style*='extension:'])"
//   ); // Because youtube video wall images are not properly classified as images

//   listAllThumbnails = listAllThumbnails.concat(Array.from(videowallImages));

//   return listAllThumbnails.filter((image) => {
//     const parent: any = image.parentElement;
...
//     const processed = Array.from(parent.children).filter((child: any) => {
//       return (
//         (child.src && child.src.includes("extension")) ||
//         isVideoPreview ||
//         isChapter
//       );
//     });
...
//   let thumbnailElements: any = FindThumbnails();

//   // Apply overlay to each thumbnail
//   thumbnailElements.forEach((thumbnailElement: any) => {
...
//       let overlayImageURL;
//       if (flip && flipBlacklist && flipBlacklist.includes(overlayImageIndex)) {
//         // Check if the image is on the blacklist
//         if (useAlternativeImages) {
//           // Check if useAlternativeImages is true
...
//       blacklistStatus =
//         "Flip blacklist found. " +
//         (useAlternativeImages
//           ? "Images will be substituted."
//           : "Images won't be flipped.");
//     })
//     .catch(() => {
...
//   console.log(
//     "MrBeastify Loaded Successfully, " +
//       highestImageIndex +
//       " images detected. " +
//       blacklistStatus
//   );
